...
try:
    ...
    logger.info("Modelo de IA inicializado com sucesso (MODO ROBUSTO).") # LINHA CORRIGIDA
except Exception as e:
    logger.critical(f"FALHA CRÍTICA NA INICIALIZAÇÃO DO MODELO: {e}")

# --- 5. LÓGICA PRINCIPAL DO BOT (COM LOOP DE FERRAMENTAS) ---
...
def main() -> None:
    ...
    logger.info("Iniciando bot Alfred - Versão Definitiva 2.1 (Revisada).")
